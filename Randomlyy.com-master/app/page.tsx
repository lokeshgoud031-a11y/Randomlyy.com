    ...
    <main className="min-h-screen bg-[#050817] text-white">
      ...
      <header className="border-b border-white/10 bg-[#070b18]/90">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          ...
          >
            {/* Globe */}
            <div className="flex h-11 w-11 items-center justify-center rounded-full bg-slate-900 text-3xl shadow-lg">
              🌍
            </div>
            ...
            <div>
              ...
              <div className="mt-1 text-[8px] uppercase tracking-[0.35em] text-slate-500">
                Global Voice
              </div>
            </div>
          </Link>
